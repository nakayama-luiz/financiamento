...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INSERIR EMPENHO");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        e.setEntidade(jTextField4.getText());
        e.setExercicio(Integer.parseInt(jTextField3.getText()));
       e.setNad(Integer.parseInt(jTextField2.getText()));
       DAO.getInstace().inserirEmpenho(e);
        jTextField2.setText("");
        jTextField3.setText("");
        jTextField4.setText("");
        JOptionPane.showConfirmDialog(null,"empenhado");
